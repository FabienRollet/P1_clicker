...
document
  .getElementById("autoClicker1")
  .addEventListener("click", upValueAutoClicker1);
...
document
  .getElementById("autoClicker2")
  .addEventListener("click", upValueAutoClicker2);
...
document
  .getElementById("autoClicker3")
  .addEventListener("click", upValueAutoClicker3);
...
document
  .getElementById("autoClicker4")
  .addEventListener("click", upValueAutoClicker4);
...
document
  .getElementById("upgradeImg1")
  .addEventListener("click", addValueOfUpgrade1);

function addValueOfUpgrade2() {
  twoGrandma = true;
}
document
  .getElementById("upgradeImg2")
  .addEventListener("click", addValueOfUpgrade2);

function addValueOfUpgrade3() {
  twoBackery = true;
}
document
  .getElementById("upgradeImg3")
  .addEventListener("click", addValueOfUpgrade3);
...
document
  .getElementById("upgradeImg4")
  .addEventListener("click", addValueOfUpgrade4);
function addValueOfUpgrade5() {
  numberClicks += 5000;
  document.getElementById("numberClicks").textContent = numberClicks;
}
document
  .getElementById("upgradeImg5")
  .addEventListener("click", addValueOfUpgrade5);
...
document
  .getElementById("upgradeImg6")
  .addEventListener("click", addValueOfUpgrade6);
...
document
  .getElementById("upgradeImg7")
  .addEventListener("click", addValueOfUpgrade7);
...
document
  .getElementById("upgradeImg8")
  .addEventListener("click", addValueOfUpgrade8);
...
document
  .getElementById("upgradeImg9")
  .addEventListener("click", addValueOfUpgrade9);
...
document
  .getElementById("upgradeImg10")
  .addEventListener("click", addValueOfUpgrade10);
...
document
  .getElementById("upgradeImg11")
  .addEventListener("click", addValueOfUpgrade11);
...
document
  .getElementById("upgradeImg12")
  .addEventListener("click", addValueOfUpgrade12);
